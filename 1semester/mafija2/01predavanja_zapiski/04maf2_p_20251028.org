#+title: 4. predavanje iz Matematične fizike 2
...
Enačba je tudi invariantna na zamenjavi \( t \to k ^2 t \) in \( x \to k x \). Če je enačba invariantna na tako zamenjavo, pravimo, da je /skalarno invariantna/. Z izbiro skalarja \( k = \frac{1}{\sqrt{t}} \) difuzijska enačba postane funkcija ene spremenljivke \( s = \frac{x}{\sqrt{t}} \)
