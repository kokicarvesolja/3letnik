...
\begin{align*}
  c k_{m'n'} C_{m' n'} \int\limits_0^{R_0} \int\limits_0^{2 \pi} \left( J_{m'} \left( \xi_{n'}^{(m')} \frac{r}{R_0} \right) \right) ^2 \cos ^2 (m' \phi) r \, \mathrm{d} r \, \mathrm{d} \phi &= \\
 \int\limits_0^{R_0} \int\limits_0^{2\pi} \delta (r - a) \delta(\phi) \frac{p_0}{\mu_0 r} r J_{m'} \left( \xi_{n'}^{(m')} \frac{r}{R} \right) \cos (m' \phi) \, \mathrm{d} r \, \mathrm{d} \phi &= \\
...
\begin{align*}
  \left. u (r, t) \right|_{r = a} &= \left. \exp \left\{ - \left( D \kappa ^2 + \frac{1}{\tau} \right) t \right\} E J_0 (\kappa r) \right|_{r = a} + u_0 \frac{I_0 (ra)}{I_0 (ra)} \\
&= u_0.
\end{align*}
