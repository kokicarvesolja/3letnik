...
[[file:figures/greenFunctionDif.png]]
...
\begin{align*}
 T \left( \vec{r}, t \right) = &\int\limits_0^t  \int\limits_{\mathcal{D}}^{} G \left( \vec{r}, \vec{r}_0, t, t_0 \right) f \left( \vec{r}_0, t \right) \, \mathrm{d} ^n \vec{r}_0 \, \mathrm{d} t \\
&+ \int\limits_{\mathcal{D}}^{} T \left( \vec{r}_0, 0 \right) G \left( \vec{r}, \vec{r}_0, 0, 0 \right) \, \mathrm{d} ^n \vec{r}_0 \\
&+ D \int\limits_0^t \int\limits_{\partial \mathcal{D}}^{} \left[ \frac{\partial }{\partial \vec{n}_{0}} T \left( \vec{r}_0, t_0 \right) G \left( \vec{r}, \vec{r}_0, t, t_0 \right) - T \left( \vec{r}_0, t_0 \right) \frac{\partial }{\partial \vec{n}_{0}} G \left( \vec{r}, \vec{r}_0, t, t_0 \right)  \right] \, \mathrm{d} ^{n - 1} S_0 \, \mathrm{d} t_0
\end{align*}
...
[[file:figures/greenFunctionWave.png]]
...
\begin{align*}
  u \left( \vec{r}, t \right) &= \int\limits_0^t \iint\limits_{}^{} \left. u \left( \vec{r}_0, t_0 \right) \frac{\partial }{\partial z}  G \left( \vec{r}, \vec{r}_0, t, t_0 \right) \right|_{z_0 = 0} \,\mathrm{d S_0} \, \mathrm{d} t_0 \\
&= \iint\limits_{\mathbb{R} ^2}^{} \int\limits_0^t f (t_0)  \delta(x_0) \delta(y_0) \left. \frac{\partial }{\partial z_{0}} G \left( \vec{r}, \vec{r}_0, t, t_0 \right) \right|_{z = 0} \,\mathrm{d}t _0 \, \mathrm{d} x_0 \, \mathrm{d} y_0 \\
&= \int\limits_0^t f(t_0) \frac{\partial }{\partial z_{0}} G \left( \vec{r}, z_0 \hat{e}_z, t, t_0 \right) \, \mathrm{d} t_0
\end{align*}

Želimo izračunati odvod Greenove funkcije

\begin{align*}
 \left. \frac{\partial }{\partial z_{0}}  \left[ \frac{1}{\left| \vec{r} \mp z_0 \hat{e}_z \right|} \cdot \delta \left( t - t_0 - \frac{1}{c} \left| \vec{r} \mp z_0 \hat{e}_{z} \right| \right) \right] \right|_{z_0 = 0} &= \left. \left[ - \frac{1}{2} \frac{\pm \left( z \mp z_0 \right) }{\left| \vec{r} \mp z_0 \hat{e}_{z} \right|^3} \right. \right. \\
& \cdot \delta \left( t- t_0 - \frac{1}{c} \left| \vec{r} \mp z_0 \hat{e}_z  \right| + \frac{1}{\left| \vec{r} \mp z_0 \hat{e}_{z} \right|} \right)  \\
&   \quad  + \frac{1}{\left| \vec{r} \mp z_0 \hat{e}_{z} \right|} \cdot \delta ' \left(  t- t_0 - \frac{1}{c} \left| \vec{r} \mp z_0 \hat{e}_{z} \right| + \frac{1}{\left| \vec{r} \mp z_0 \hat{e}_{z} \right|} \right) \\
& \left. \left.\cdot \frac{1}{c} \cdot \frac{1 \pm (z \mp z_0)}{\left| \vec{r} \mp z_0 \hat{e}_{z} \right|}\right] \right|_{z_0 = 0} \\
&= \pm \frac{z}{r ^3} \delta \left( t - t_0 - \frac{r}{c} \right) \pm \frac{z}{cr ^2} \delta ' \left( t - t_0 - \frac{r}{c} \right).
\end{align*}
