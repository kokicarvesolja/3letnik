...
&= \int\limits_{}^{} \frac{1}{\sqrt{3}} \frac{1}{\left( 2r_B \right)^{\frac{3}{2}}} \frac{r}{r_B} \exp \left\{ - \frac{r}{2 r_B} \right\} \\
&\quad \cdot \sqrt{\frac{3}{4 \pi}} \cos \theta r \cos \theta \frac{2}{r_B^{\frac{3}{2}}} \exp \left\{ - \frac{r}{r_B} \right\} \frac{1}{\sqrt{4 \pi}} \cdot r ^2 \, \mathrm{d} r \, \mathrm{d} (\cos \theta) \, \mathrm{d} \phi\\
