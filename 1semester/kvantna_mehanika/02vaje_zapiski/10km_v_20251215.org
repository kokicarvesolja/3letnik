...
[dopolni razčlenitev iz x^4 na x^2 x x^2]
...
integrand vedno ničeln. Integral lihe funkcije pa je vedno \( 0 \).
...
\begin{align*}
  \lambda \left\langle x m \middle| x ^2 \middle| n \right\rangle &= \lambda \left( \frac{x_0}{\sqrt{2}} \sqrt{m} \left\langle m - 1 \right| + \sqrt{m + 1} \left\langle m + 1 \right| \right) \cdot \frac{x_0 ^2}{2} \left( \sqrt{n} \sqrt{n - 1} \left| n - 2 \right\rangle + (2n + 1) \left| n \right\rangle + \sqrt{n + 1} \sqrt{n + 2} \left| n + 2 \right\rangle \right)\\
\end{align*}
...
\begin{align*}
\sum\limits_{m \ne n}^{} \frac{\left| \left\langle m \middle| \lambda x ^3 \middle| n \right\rangle \right| ^2}{E_n - E_m} &= \frac{\lambda ^2 x_0 ^6}{8} \left( \frac{9n ^3}{\hbar \omega} + \frac{9 (n ^3 + 3 n ^2 + 3n + 1)}{(- \hbar \omega)} + \frac{n ^3 + 5n ^2 + 6n + n ^2 + 5n + 6}{(- 3\hbar \omega)} + \frac{n ^3 - 3n ^2 + 2n}{3 \hbar \omega} \right) \\
&= - \frac{\lambda ^2 x_0 ^6}{8 \hbar \omega} \left( 30n ^2 + 30 n + 11 \right)
\end{align*}

[polinome zamenjaj s produkti]
...
\[ \left| n \right\rangle  = \left| n_0 \right\rangle + \frac{\lambda x_0 ^3}{\sqrt{8}} \left( \frac{\sqrt{n (n - 1) (n - 2)}}{3 \hbar \omega} \left| n_0 - 3 \right\rangle + \frac{3n\sqrt{n}}{\hbar \omega} \left| n_0 - 1 \right\rangle - \frac{3(n + 1) \sqrt{n + 1}}{\hbar \omega} \left| n_0 + 1 \right\rangle - \frac{\sqrt{(n + 1) (n + 2) (n + 3)}}{3 \hbar \omega} \left| n_0 + 3 \right\rangle \right)
\]
