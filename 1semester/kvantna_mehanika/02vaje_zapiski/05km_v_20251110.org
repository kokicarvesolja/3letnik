...
\[ \left\langle x ^2, t \right\rangle  = \frac{x_0 ^2}{2} \left\langle \left( a + a^{\dagger} \right) ^2, t \right\rangle = \frac{x_0 ^2}{2} \left\langle a ^2 + a a^{\dagger} + a^{\dagger} a + a ^{\dagger} ^2, t \right\rangle
\]

Tako smo zapisali, saj operatorja \( a \) in \( a^{\dagger} \) ne komutirata.

Upoštevamo, da sta \( a ^2 \) in \( a ^{\dagger} ^2 \) hermitsko adjungirana, kar pomeni, da bo njuna vsota enaka \( 2 \mathrm{Re} \left\langle a ^2, t \right\rangle \). Hkrati pa upoštevamo še identiteto
...
Nadaljujemo z računanjem v Heisenbergovi sliki. Nadaljujemo z zapisom

\begin{equation}
\label{eq:3}
 \left\langle x ^2, t \right\rangle = \frac{x_0 ^2}{2} \left( 2 \mathrm{Re} \left\langle a ^2, t \right\rangle + 2 \left\langle a ^{\dagger} a, t \right\rangle + 1\right)  \frac{x_0 ^2}{2} \left( 2 \mathrm{Re} \left\langle a ^2(t), 0 \right\rangle + 2 \left\langle a ^{\dagger} a, 0 \right\rangle + 1 \right)
\end{equation}
...
\[ \left\langle x ^2, t \right\rangle = \frac{x_0 ^2}{2} \left( 2 \mathrm{Re} \left( e^{- \mathrm{i} 2 \omega t} \left\langle a ^2, 0 \right\rangle \right) + 2 \left\langle a ^{\dagger} a, 0 \right\rangle + 1\right)
\]
