...
\[ G \left( \mathbf{r} - \mathbf{r}' \right) = \frac{1}{\epsilon_0 \left( 2 \pi \right) ^3} \int\limits_0^{\infty} \int\limits_0^{2\pi} \int\limits_{-1}^1 \frac{1}{k ^2} e^{\mathrm{i} \mathbf{k}(\mathbf{r} - \mathbf{r}')} 
\]
