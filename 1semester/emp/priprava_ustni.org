...
\[ \mathrm{d} W = e_0 \nabla \phi(\mathbf{r}_0) \cdot \mathrm{d} \mathbf{r} - \nabla \left( \vec{p}_e \cdot \mathbf{E}(\mathbf{r}_0) \right) \cdot \mathrm{d} \mathbf{r} = - \mathbf{F} \cdot \mathrm{d} \mathbf{r}
\]

Upoštevamo, sedaj že enkrat uporabljeno, identiteto

\[ \nabla \left( \mathbf{p}_e \cdot \mathbf{E} (\mathbf{r}_0) \right) = \mathbf{p}_0 \times \left( \nabla \times \mathbf{E}(\mathbf{r}_0) \right) + \left( \mathbf{p}_0 \cdot \nabla \right) \mathbf{E}(\mathbf{r}_0).
\]
...
\[ \mathbf{F} = e \mathbf{E}(\mathbf{r}_0) + \left( \mathbf{p}_0 \cdot \nabla \right) \mathbf{E}(\mathbf{r}_0).
\]
