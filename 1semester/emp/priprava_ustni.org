...
\[ \mathbf{F} = \frac{\mu_0 I_1 I_2}{4 \pi} \int\limits_{c_1}^{} \int\limits_{c_2}^{} \frac{\mathrm{d} \mathbf{l}_1 \times \left( \mathrm{d} \mathbf{l}_2 \times \left( \mathbf{r}(l_2) - \mathbf{r}(l_1) \right) \right)}{\left| \mathbf{r}(l_2) - \mathbf{r}(l_1) \right|}.
\]
