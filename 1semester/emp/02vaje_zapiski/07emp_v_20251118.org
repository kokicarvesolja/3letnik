...
* Magnetna sila v koaksialnem kablu :dodaj_navodila:
#+begin_problem
...
\[ \vec{F}_m = \frac{1}{\mu_0} \oiint\limits_S^{} \left[ \vec{B} \left( \vec{B} \cdot \vec{n} \right) - \frac{1}{2} B ^2 \vec{n} \right] \, \mathrm{d} s
\]
