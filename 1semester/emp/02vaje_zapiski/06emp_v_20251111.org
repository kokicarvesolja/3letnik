...
Problem začnemo reševti tako, da določimo, da je disk v ravnini \( xy \) in je vektor kroženja zapisan z \( \vec{\omega} = (0, 0, \omega) \).
...
Prispevek k toku je celoten naboj, ki gre skozi dano površino - celoten tok na kolobarju gre skozi presek ravno v obhodnem času \( \frac{2 \pi }{\omega} = t_0 \). Torej bo prispevek k toku
