...
\begin{equation}
\label{eq:2}
E_{\phi} = - \left. \frac{1}{r} \frac{\partial U}{\partial \phi} \right|_{\phi = 0}
\end{equation}
...
&= \left. \frac{p_e}{4 \pi \epsilon_0 a ^3} \cos \theta + \frac{2 p_e}{4 \pi \epsilon_0} \frac{\cos \theta}{r ^3} \right|_{r = a}
\end{align*}
