...
\begin{align*}
  \phi \left( \vec{r} \right) &= \frac{1}{4 \pi \epsilon_0} \int\limits_{}^{} \frac{\rho \left( \vec{r} \, ' \right)}{r} \, \mathrm{d} ^3 \vec{r} \, ' + \frac{1}{4 \pi \epsilon_0} \int\limits_{}^{} \frac{\rho \left( \vec{r} \, ' \vec{r} \, ' \cdot \vec{r} \right)}{r ^3} \, \mathrm{d} ^3 \vec{r} \, ' \\
