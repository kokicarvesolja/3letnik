...
\[ G \left( \vec{r} - \vec{r} \, '\right) = \frac{1}{\left( 2\pi \right) ^3} \int\limits_0^{\infty} \int\limits_0^{2\pi} \int\limits_{-1}^{1} \, \mathrm{d} \phi \, \mathrm{d} \left( \cos \theta \right) k ^2 \, \mathrm{d} k  e^{\mathrm{i} k \left| \vec{r} - \vec{r} \, ' \right| \cos \theta} \frac{1}{\epsilon_0 k ^2}
\]
...
\[ \mathrm{d} W = \int\limits_{}^{} \mathrm{d} \rho \cdot  \phi \left( \vec{r} \right) \, \mathrm{d} ^3 \vec{r} = \int\limits_{}^{} \mathrm{d} \alpha \rho \left( \vec{r} \right) \alpha \phi \left( \vec{r} \right) \, \mathrm{d} ^3 \vec{r}
\]
...
kjer smo upoštevali \( \rho \left( \vec{r} \right) = \epsilon_0 \nabla \cdot \vec{E} \). Hkrati upoštevamo še relacijo \( \vec{E} = - \nabla \cdot \phi \).

Uporabimo identiteto

\[ \nabla \cdot \left( f \cdot \vec{g} \right) = \nabla f \cdot \vec{g} + f \nabla \cdot \vec{g}
\]
