...
Izberemo valjast volumen, katerega osnovni ploskvi sta vsaka v svoji snovi. Osnovna ploskev v snovi 1 ima normalo \( \vec{n}_1 \), osnovna ploskev v snovi 2 pa ima normalo \( \vec{n}_2 \). Obe normali kažeta v snov. Predpostavimo majhno višino valja.
