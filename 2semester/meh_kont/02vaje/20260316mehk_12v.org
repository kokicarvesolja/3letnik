...
Nastavek podan v navodili zadosti robnim pogojem.
...
\[ \Delta_{\perp } = - \sum\limits_{m, n}^{} A_{mn} \left[ \left( \frac{m \pi}{a} \right) ^2 \sin \frac{m \pi x}{a} \sin \frac{n \pi y}{a} + \left( \frac{n \pi}{a} \right) ^2 \sin \frac{m \pi x}{a} \sin \frac{n \pi x}{a} \right].
\]
