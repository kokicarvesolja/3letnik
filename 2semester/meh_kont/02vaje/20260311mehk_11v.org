...
\[ k ^2 = - \frac{\rho \omega ^2 ( 1 + \sigma ) (1 - 2 \sigma)}{E (1 - \sigma)},
\]
...
#+begin_note
  ...
  \[ \frac{\partial ^2 }{\partial x ^2} z_l (x) + \frac{2}{x} \frac{\partial }{\partial x} z_l(x) + \left( 1 - \frac{l (l + 1)}{x ^2} \right) z_l (x) = 0
  \]
