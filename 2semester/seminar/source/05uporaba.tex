...
Indeks \( v \) označuje lastnosti plina v mehurčku, indeks \( l \) lastnosti tekočine. \( \rho \) je gostota, \( T \) je temperatura, \( h \) je specifična entalpija in indeks \( \mu \) označuje ravnovesje kemijskega potenciala med tekočino in plinom. Enačba doda dva popravka. V prvem členu doda popravek k površinski energiji ter doda zadnji člen, ki je reverzibilno delo mehurčka pri razširjanju. Spodnja meja občutljivosti detektorja je bila izračunana na \( E_t = \left(1.20 \pm 0.1\right) \mathrm{keV} \)~\cite{amole_dark_2019}.
