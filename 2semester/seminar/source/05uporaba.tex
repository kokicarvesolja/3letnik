...
\begin{wrapfigure}{R}{8cm}
  ...
  \end{center}
  \caption{\small Detektor PICO60~\cite{amole_dark_2019}}\label{fig:pico60}
\end{wrapfigure}
...
Indeks \( v \) označuje lastnosti plina v mehurčku, indeks \( l \) lastnosti tekočine. \( \rho \) je gostota, \( T \) je temperatura, \( h \) je specifična entalpija in indeks \( \mu \) označuje ravnovesje kemijskega potenciala med tekočino in plinom. Energija je bila izračunana na \( E_t \approx \left(1.20 \pm 0.1\right) \mathrm{keV} \).
