...
\]
* Naloga: FCC in približek tesne vezi
#+begin_problem
Uporabi približek tesne vezi za izračun disperzijske relacije, širine energijske reže in gostoto stanj v FCC kristalni strukturi. Predpostavi, da so pokrivalni integrali majhni in zanemari pokrivalni integral \( \alpha \).
#+end_problem
...
Na spodnji sliki se nahaja FCC kristal z narisanim elektronskim pasom \( s \) za vsak atom. 
