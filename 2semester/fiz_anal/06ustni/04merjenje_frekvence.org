...
Izhod iz fazno vpete zanke je potem
...
Prenosna funkcija fazno vpete zanke je potem
...
- tip I. (XOR gate)  (glej Marko's chest zapiske), ki ima slabost, da ne loči med zaostajanjem in prehitevanjem signala.
...
Enačbo \eqref{ali4:1} odvajamo po času in nadomestimo \( \dot{\hat{\omega}}_s \) v odvajanem izrazu z \eqref{ali4:2}. Dobimo
...
Shema modificiranega RC filtra se nahaja na spodnji slika
