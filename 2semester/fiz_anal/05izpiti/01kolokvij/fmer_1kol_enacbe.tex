...
\begin{primer}[Padec kroglice]
  ...
  \( h_{n + 1} = \delta h_n = \delta \bar{H} + \delta \eta  \), kjer je \( \delta = \frac{1}{2} h_0 \).
  ...
  Varianca bo \( P_{n + 1} = M_{n + 1} = \Phi_{n + 1} ^2 P_n + \Gamma_n ^2 Q_n \), kjer je \( \Gamma_n ^2 Q_n = \delta ^2 \sigma_H ^2 \).
\end{primer}
