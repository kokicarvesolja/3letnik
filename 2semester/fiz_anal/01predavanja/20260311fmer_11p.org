...
\frac{\partial \mathrm{tr} \tilde{P}}{\partial B} &= 0 = 2B R - \left( H \lambda \right)^T \\
\frac{\partial \mathrm{tr} \tilde{P}}{\partial \lambdal} &= 0 = \left( A + BH - I \right)^T .
\end{align*}
...
V oklepaju v zadnji vrstici prepoznamo zgornji izraz in ga nadomestimo z \( \left( \frac{\lambda}{2} \right)^{-1} \).
