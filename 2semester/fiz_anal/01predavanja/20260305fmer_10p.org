...
\begin{align*}
  \left\langle p_x ^2 \right\rangle &= a_{xx } ^2 \left\langle m_x \right\rangle ^2 + (1 - a_{xx }) ^2 \left\langle r ^2 \right\rangle + a_{xx } (1 - a_{xx }) \left\langle m_x r \right\rangle \\
...
\[ p_v = a_{vx} m_x + m_v + b_v r = \left( a_{vx} (m_x - r) + m_v \right).
\]
