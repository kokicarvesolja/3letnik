...
Red senzorja je direktno koreliran z redom dinamike spremenljivke, ki jo merimo. Torej senzor \( n \)-tega reda obravnavamo kot optimalen senzor za spremenljivko reda dinmaike v sistemu \( S \) in se spreminja kvečjemu kot

\[ \frac{\mathrm{d} ^{(n)} }{\mathrm{d} x^{(n)}} x = 0 + w.
\]

[glej Markejeve zapiske.]
** Senzor prvega reda
...
Veliko merilcev so senzor 1. reda - termometer, merilnik hitrosti v avtu, itd. Nobeden od njih nam ne bi koristil, če bi imeli odvod. Senzor v peči je primer senzorja, ki ni prvega reda, saj spremlja temperaturo in njen odvod, da ve, kdaj se peč prižge.
...
Kaj se zgodi v primeru, če s senzorjem prvega reda merimo dinamike višjih redov? Obstajajo tri možnosti.
